    ...
    public partial class LicenseView : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (valid)
                {
                    VolleybalCompetition_creator.Properties.Settings.Default.LicenseKey = tempKey.Key();
                    VolleybalCompetition_creator.Properties.Settings.Default.Save();
                    textBox1.Clear();
